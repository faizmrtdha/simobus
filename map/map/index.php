	...
	<body>
		...
		<script>
			function initMap() {
			  var mapOptions = {
			    zoom: 18,
			    center: {<?php echo'lat:'. $latitudes[$lastcount] .', lng:'. $longitudes[$lastcount] ;?>}, //{lat: --- , lng: ....}
	    ...
	    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0ux46CtnHoOEtQKBxAy0szik2lzBSWhw&callback=initMap"></script>
